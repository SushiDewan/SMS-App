...
import 'package:smsapp/Login/registerAdmin.dart';

class SchoolCodeAdmin extends StatefulWidget {
  @override
  _SchoolCodeAdminState createState() => _SchoolCodeAdminState();
}

class _SchoolCodeAdminState extends State<SchoolCodeAdmin> {
