...
class _ChooseUserBodyState extends State<ChooseUserBody>
  ...
  Future<SchoolIdModel> getId() async {
    return await ApiConstants().getId(widget.id).then((sclId) {
      return sclId;
    });
  }
            ...
            Container(
              ...
              child: FutureBuilder(
                ...
                builder: (BuildContext context,
                    AsyncSnapshot<SchoolIdModel> snapshot) {
