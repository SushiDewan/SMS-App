...
class AdminRegisterBloc with Validators {
  ...
  Stream<String> get contactnum => _contactnum.stream.transform(contactValidator);
  Stream<String> get address => _address.stream.transform(addressValidator);
  Stream<String> get edn => _edn.stream.transform(ednValidator);
